...
NetworkParticipation_SC_consensus = NetworkLabels' * abs(SC_U_consensus).^2; %formal Wavefunction probability distribution function
...
for i = 1:n_subjects
    ...
    SC_U_sub_matched = match_eigs(SC_U_sub, SC_U_consensus);
...
exportgraphics(FIG, 'C:\Users\flame\Box\Projects\Eigenmode_Variability\Figures\Fig5_RSN-Neurosynth\RSN_SC_MeanAcrossSubs_NotMaxScaled.png', 'Resolution',600);
